class Sidebar extends HTMLElement {
  connectedCallback() {
    ...
    this.innerHTML = `
        <div class="part" onclick="redirect('dashboard')">
        ...
        <div class="part" onclick="redirect('items')">
        ...
        <div class="part" onclick="redirect('employee')">
        ...
        <div class="part" onclick="redirect('position')">
        ...
        <div class="part" onclick="redirect('office')">
        ...
        <div class="part" onclick="redirect('request')">
        ...
        <div class="part" onclick="redirect('report')">
