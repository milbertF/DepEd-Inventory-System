        ...
        <div class="con">
            ...
            <div class="searchContainer">
                ...
                <div class="status-filter-container">
                    ...
                    Canceled
                            <span class="status-count">(<?= $statusCounts['canceled'] ?>)</span>
                        </label>
                    </div>
                    <div class="status-filter-checkbox">
                        <input type="checkbox" id="filter-received" class="status-checkbox" data-status="received">
                        <label for="filter-received">
                         Received
