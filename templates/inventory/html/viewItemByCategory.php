...
<div id="deleteAlertData" 
     ...
     data-is-last-item="<?php echo isset($_SESSION['deleted_is_last_item']) && $_SESSION['deleted_is_last_item'] ? 'true' : 'false'; ?>"
     style="display: none;">
</div>

<?php

if (isset($_SESSION['deleted_item_name'])) {
    unset($_SESSION['deleted_item_name']);
    unset($_SESSION['deleted_is_last_item']);
}
?>
          ...
          <div class="searchFilterWrapper" style="position: relative; display: flex; gap: 15px; align-items: center; margin-bottom: 20px;">
            ...
            <div class="filterControls" style="position: relative;">
              ...
              <button id="toggleBrandFilter" class="filter-btn" title="Filter by Brand">
                ...
                <div class="tooltip">Filter by Brand</div>
    </button>
              </button>
              ...
              <div class="filterContainer hidden" id="brandFilterContainer" style="right: 0; min-width: 200px;">
                <div class="filter-header">
                  <i class="fas fa-tags"></i>
              ...
              <div class="filterContainer hidden" id="quantityFilterContainer" style="right: 0; min-width: 200px;">
                ...
                <div class="quantity-options">
                  <button id="sortLowToHigh" class="quantity-option">
                    <i class="fas fa-sort-amount-up"></i> Sort: Low to High
                  </button>
              ...
              <div class="dateFilterContainer hidden" id="dateFilterContainer" style="right: 0; min-width: 250px;">
                ...
                <div class="filter-actions">
                  <button id="filterByDateBtn" class="filter-btn">Apply Date Filter</button>
                  <button id="resetDateFilterBtn" class="filter-btn">Reset Date</button>
                </div>
              </div>
